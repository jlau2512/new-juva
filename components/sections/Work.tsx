...
type WorkItem = { readonly tag: string; readonly title: string; readonly desc: string };
...
function WorkCard({ item, idx }: { item: WorkItem; idx: number }) {
  ...
  return (
    <motion.div
      ...
      className="js-work-card group relative overflow-hidden rounded-3xl aspect-[4/3]"
    >
